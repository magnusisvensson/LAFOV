...
if system_file and form_file:
    ...
    try:
        ...
        align_center = Alignment(vertical="center", horizontal="left", wrap_text=True)
        font_school = Font(bold=True)
        ...
        for skola, grp in df.groupby("Startskola"):
            ...
            # skolnamn (rubrik)
            ws.append([skola, "", "", "", ""])
            ws.cell(row=start_row, column=1).font = font_school

            # studenter
            for _, r in grp.iterrows():
                ws.append(["", r["År 1"], r["År 2"], r["År 3"], r["År 4"]])
